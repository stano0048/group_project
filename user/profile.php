...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$full_name || !$email) {
        ...
        $pdo->prepare("UPDATE users SET full_name=?, email=?, phone=?, whatsapp_number=? WHERE id=?")->execute([
            $full_name, $email, $phone, $whatsapp, $user['id']
        ]);
...
$sidebar_role = $user['role'] === 'seller' ? 'seller' : 'user';
...
<div class="dashboard-wrapper">
    <div class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="/user/profile.php" class="active">Profile</a></li>
